<?php
$wikiname = "FLOSSCamp 2011";
$wikitagline = "Întâlnirea comunităților FLOSS din România";
$camplocation = "cândva prin vara 2011, România";
?>
...
<head>
	...
	<link rel="stylesheet" href="/css/style.css?v=2011" type="text/css" media="screen, projection" />	
...
<body>
	<div id="continut">
		...
		<div id="gat">
			<ul>
				<li><a href="/2011/" title="Acasă">Despre</a></li>
				<!--li><a href="/2010/propuneri" title="Propuneri">Propuneri</a></li-->
				<!--li><a href="/2010/inscriere" title="Înscriere">Înscriere</a></li-->
				<!--<li><a href="/2011/membri" title="Pe cine vei întâlni">Participanți</a></li>-->
				<!--<li><a href="/2011/poze/index.php" title="Poze de la FLOSSCamp 2010">Poze</a></li>-->				
				<!--<li><a href="/2011/calea" title="Hai și tu!">Cum ajungi?</a></li>-->
                <!--<li><a href="/2011/promo" title="Susține-ne!">Promovează</a></li>-->
                <!--<li><a href="/2011/contact" title="Scrie-ne">Contact</a></li>-->
			</ul>
		</div>
		<div id="corp">
			<?php echo $html ?>
